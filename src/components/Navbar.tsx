  ...
  return (
    <div className="flex items-center justify-between p-4">
      ...
      <div className="flex items-center gap-6 justify-end w-full">
        <div className="bg-white rounded-full w-8 flex items-center justify-center cursor-pointer">
          <Image
            className=""
            src={"/message.png"}
            alt=""
        ...
        <div className="bg-white rounded-full w-8 flex items-center justify-center cursor-pointer relative">
          <Image
            className=""
